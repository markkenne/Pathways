/* Program Description: Floor Cost Estimator. This program inputs a budget amount, room length and width in ft, and material cost
   ...
   (3) Prompt for Budget amount and validate input
   (4) Prompt for Room Length and validate input
   (5) Prompt for Room Width and validate input
   (6) Prompt for flooring cost and validate input
