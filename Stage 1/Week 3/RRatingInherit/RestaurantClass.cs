// Restaurant Class for use in RRatingInherit program
// Class Description: Create a private method for retrieving data for Restaurant. This is a parent to FineDining and FastFood which are used to return additional data
...
namespace restaurantAPP
{
  class Restaurant
    {        
        ...
        // RName is the restaurant name and RRating is the restaurant name,
        // Both RName and RRating will be an automatic properties.
