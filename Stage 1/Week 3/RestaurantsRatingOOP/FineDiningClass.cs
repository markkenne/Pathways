...
namespace restaurantAPP
{
  class FineDining: Restaurant
    {        
        ...
        public FineDining () : base(null, -1)  // use the parent constructor for the name and rating or base() would work
        {
            RReservation = false;
        }
...
/* mk crap
public class FastFood: Restaurant // derived class (child)
{
    private bool drivethru;  // field

    public bool Drivethru;  // field

   
public FastFood (string name, string rating, bool drivethru) : base(Name, Rating)
    {
        Drivethru = drivethru;
    }
